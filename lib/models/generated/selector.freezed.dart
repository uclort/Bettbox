...
mixin _$TrayState {
 ...
 Mode get mode; int get port; bool get autoLaunch; bool get systemProxy; bool get tunEnable; bool get isStart; String? get locale; Brightness? get brightness; List<Group> get groups; List<Group> get allGroups; SelectedMap get selectedMap; bool get wakelockEnabled; Map<String, int?> get delays; bool get enableTraySpeed; TrayClickBehavior get trayClickBehavior;
...
@useResult
$Res call({
 Mode mode, int port, bool autoLaunch, bool systemProxy, bool tunEnable, bool isStart, String? locale, Brightness? brightness, List<Group> groups, List<Group> allGroups, SelectedMap selectedMap, bool wakelockEnabled, Map<String, int?> delays, bool enableTraySpeed, TrayClickBehavior trayClickBehavior
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Mode mode,  int port,  bool autoLaunch,  bool systemProxy,  bool tunEnable,  bool isStart,  String? locale,  Brightness? brightness,  List<Group> groups,  List<Group> allGroups,  SelectedMap selectedMap,  bool wakelockEnabled,  Map<String, int?> delays,  bool enableTraySpeed,  TrayClickBehavior trayClickBehavior)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TrayState() when $default != null:
return $default(_that.mode,_that.port,_that.autoLaunch,_that.systemProxy,_that.tunEnable,_that.isStart,_that.locale,_that.brightness,_that.groups,_that.allGroups,_that.selectedMap,_that.wakelockEnabled,_that.delays,_that.enableTraySpeed,_that.trayClickBehavior);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Mode mode,  int port,  bool autoLaunch,  bool systemProxy,  bool tunEnable,  bool isStart,  String? locale,  Brightness? brightness,  List<Group> groups,  List<Group> allGroups,  SelectedMap selectedMap,  bool wakelockEnabled,  Map<String, int?> delays,  bool enableTraySpeed,  TrayClickBehavior trayClickBehavior)  $default,) {final _that = this;
switch (_that) {
case _TrayState():
return $default(_that.mode,_that.port,_that.autoLaunch,_that.systemProxy,_that.tunEnable,_that.isStart,_that.locale,_that.brightness,_that.groups,_that.allGroups,_that.selectedMap,_that.wakelockEnabled,_that.delays,_that.enableTraySpeed,_that.trayClickBehavior);case _:
  throw StateError('Unexpected subclass');
