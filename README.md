...
>
> 主要修改包括：macOS TUN/DNS 自动托管及唤醒恢复、菜单栏状态与快捷操作、WebDAV 配置同步边界、自定义应用内更新，以及 custom-mihomo 的接口 DNS 和 Snell v6 适配。完整说明见[自定义变更总账](.custom-build/release-notes/CUSTOM_CHANGES.md)和[本次发布增量](.custom-build/release-notes/LATEST_CHANGES.md)。
